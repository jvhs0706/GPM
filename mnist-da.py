...
if __name__ == "__main__":
    ...
    if args.gamma is None:
        if args.gamma_factor is None:
            ...
            args.gamma = args.gamma_factor * math.sqrt(num_params)
    ...
    accuracy = 0.9874 if args.pretrained else 0.1 # hard coded, for speed
    success = 0
    ...
    print(f'mnist,lenet,{num_params},{args.pretrained},{accuracy},{args.batch_size},{args.clip_norm},{args.beta},{args.gamma},{args.sigma},{args.epsilon},{args.actual_epsilon},{args.delta},{success_rate}')