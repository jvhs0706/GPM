...
parser.add_argument('--gamma_hue', type=str, help="An additional hue for gamma value in the output")
...
if __name__ == "__main__":
    ...
    msg = f'{args.num_records},{args.num_bins},{args.beta},{args.gamma},{args.sigma},{args.epsilon},{args.actual_epsilon},{args.delta},{success_rate},{math.sqrt(mean_l2_sq)}'
    if args.gamma_hue is not None and args.gamma_hue != '':
        msg = msg + f',{args.gamma_hue}'
    print(msg)
