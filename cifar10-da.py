...
parser.add_argument('--gamma_to_sqrt_d', type=float, help='Gamma as a multiple of sqrt(d), where d is the number of parameters in the model')
...
if __name__ == "__main__":
    ...
    if args.gamma is None:
        if args.gamma_to_sqrt_d is not None:
            args.gamma = args.gamma_to_sqrt_d * math.sqrt(num_params)
        else:
